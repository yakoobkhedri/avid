...
togglePassword.addEventListener('click', () => {
  ...
  // Regex to match exactly 5 digits and 5 alphabetic characters
  ...
  passwordInput.addEventListener('input', () => {
      ...
      if (passwordRegex.test(passwordValue)) {
          // Enable the submit button if the password is valid
          submitPassword.disabled = false;
      } else {
          // Disable the submit button if the password is invalid
